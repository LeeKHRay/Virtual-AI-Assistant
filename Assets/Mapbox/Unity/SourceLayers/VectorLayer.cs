...
namespace Mapbox.Unity.Map
{
	...
	public class VectorLayer : AbstractLayer, IVectorDataLayer
	{
		...
		public void SetFeatureSubLayerActive(string featureName, bool active)
		{
			var subLayer = FindFeatureSubLayerWithName(featureName);
			if (subLayer != null)
			{
				subLayer.SetActive(active);
			}
		}
		...
		public virtual void RemovePointsOfInterestSubLayerWithName(string poiLayerName)
		{
			...
			if (layerToRemove != null)
			{
				Debug.Log("RemovePointsOfInterest");
				_layerProperty.OnSubLayerPropertyRemoved(new VectorLayerUpdateArgs { property = layerToRemove });
			}
		}
		...
		public void SetPointsOfInterestSubLayerActive(string poiLayerName, bool active)
		{
			var subLayer = FindPointsofInterestSubLayerWithName(poiLayerName);
			if (subLayer != null)
			{
				subLayer.SetActive(active);
			}
		...
		public void SetPointsOfInterestSubLayerDensity(string poiLayerName, int density)
		{
			var subLayer = FindPointsofInterestSubLayerWithName(poiLayerName);
			if (subLayer != null)
			{
				subLayer.density = density;
			}
		}
