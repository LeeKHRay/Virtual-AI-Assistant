...
public class TetrominoOpponent : Agent
{
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        shape = TetrisGameboard.shapeToIdx[gameObject.name[0]];
        ...
        if(!stopped && !gameboard.lose)
        {
            ...
            if (action1 == 1) // swap
            {
                ...
                else
                {
                    ...
                    dir = Quaternion.Euler(0, 0, transform.eulerAngles.z) * new Vector2(0, 1);
